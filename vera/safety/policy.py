...
DEFAULT_RULES: dict[str, PolicyAction] = {
    ...
    # Job hunter — fully automatic (user-requested)
    "job_hunter.*": PolicyAction.ALLOW,
    "job_hunter.search_jobs": PolicyAction.ALLOW,
    "job_hunter.browse_job_board": PolicyAction.ALLOW,
    "job_hunter.read_job_posting": PolicyAction.ALLOW,
    "job_hunter.evaluate_job_fit": PolicyAction.ALLOW,
    "job_hunter.generate_cover_letter": PolicyAction.ALLOW,
    "job_hunter.fill_application": PolicyAction.ALLOW,
    "job_hunter.upload_resume": PolicyAction.ALLOW,
    "job_hunter.submit_application": PolicyAction.ALLOW,
    "job_hunter.check_application_status": PolicyAction.ALLOW,
    "job_hunter.update_profile": PolicyAction.ALLOW,
    "job_hunter.set_preferences": PolicyAction.ALLOW,
    "job_hunter.run_job_scan": PolicyAction.ALLOW,
    # Planner — all safe (read/write own data only)
    "planner.*": PolicyAction.ALLOW,
    # Wellness — all safe (read/write own data only)
