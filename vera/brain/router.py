...
INTENT_AGENT_MAP: dict[str, str] = {
    ...
    "histogram": "data_analyst",
    "correlation": "data_analyst",
    "ml": "data_analyst",
    "train_model": "data_analyst",
    "mouse": "computer_use",
    "click": "computer_use",
    "keyboard": "computer_use",
    "clipboard": "computer_use",
    "ocr": "computer_use",
    "window": "computer_use",
    "docker": "devops",
    "kubernetes": "devops",
...
KEYWORD_PATTERNS: list[tuple[re.Pattern, str, str]] = [
    ...
    # Writer (translate pattern removed — language_tutor translate pattern fires first)
    (
...
class TierRouter:
    ...
    def _agent_tier(self, agent_name: str) -> ModelTier:
        ...
        tier_map = {
            ...
            "data_analyst": ModelTier.SPECIALIST,
            "computer_use": ModelTier.SPECIALIST,
            "devops": ModelTier.SPECIALIST,
            "cybersecurity": ModelTier.SPECIALIST,
            "travel": ModelTier.SPECIALIST,
            "shopping": ModelTier.SPECIALIST,
            "social_media": ModelTier.SPECIALIST,
            "education": ModelTier.EXECUTOR,
            "database": ModelTier.SPECIALIST,
            "translation": ModelTier.SPECIALIST,
            "presentation": ModelTier.SPECIALIST,
            "automation": ModelTier.SPECIALIST,
            "calendar": ModelTier.SPECIALIST,
            "network": ModelTier.SPECIALIST,
            "pdf": ModelTier.EXECUTOR,
            "spreadsheet": ModelTier.EXECUTOR,
            "api": ModelTier.SPECIALIST,
