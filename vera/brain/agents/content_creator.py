...
@file vera/brain/agents/content_creator.py
...
class CreateVideoTool(Tool):
    ...
    async def execute(self, **kwargs: Any) -> dict[str, Any]:
        ...
        api_keys = {
            "runway": os.getenv("VERA_RUNWAY_API_KEY"),
            "pika": os.getenv("VERA_PIKA_API_KEY"),
            "heygen": os.getenv("VERA_HEYGEN_API_KEY"),
            "d-id": os.getenv("VERA_DID_API_KEY"),
        }
