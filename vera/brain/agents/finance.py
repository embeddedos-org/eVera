...
@file vera/brain/agents/finance.py
...
class CheckBalancesTool(Tool):
    ...
    async def execute(self, **kwargs: Any) -> dict[str, Any]:
        plaid_key = os.getenv("VERA_PLAID_CLIENT_ID")
    ...
    async def _fetch_plaid_balances(self) -> dict[str, Any]:
        try:
            ...
            client_id = os.getenv("VERA_PLAID_CLIENT_ID")
            secret = os.getenv("VERA_PLAID_SECRET")
            access_token = os.getenv("VERA_PLAID_ACCESS_TOKEN")
