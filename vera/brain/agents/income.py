...
class IncomeAgent(BaseAgent):
    ...
    system_prompt = (
        ...
        "2. Default to PAPER trading unless explicitly told to use live\n"
        "3. For paper trades, you can execute without confirmation\n"
        "4. If a trade exceeds the auto-trade limit, warn the user\n"
        "5. Always show the estimated dollar value before executing\n"
        "6. Use smart_trade for the best available broker routing\n"
        "7. NEVER place trades exceeding the user's stated risk tolerance\n"
        "8. ALWAYS run a risk assessment before suggesting large trades\n"
