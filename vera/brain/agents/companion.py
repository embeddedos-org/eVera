...
class CompanionAgent(BaseAgent):
    ...
    def respond_offline(self, state: VeraState) -> str:
        ...
        if any(phrase in transcript for phrase in ["my name is", "call me", "i'm ", "i am "]):
            if user_name:
                return f"Nice to meet you, {user_name}! 🎉 I'm Vera, your buddy! I'll remember your name. What can I do for you?"
            return "Nice to meet you! 🎉 I'm Vera, your buddy! What can I help you with?"
        ...
        if not user_name:
            prompts = [
                f"{greeting} I'm Vera, your AI buddy! 👋 What should I call you?",
                "Hey there! I'm Vera! 👋 Before we get started — what's your name?",
