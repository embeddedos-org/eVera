...
BUDDY_PERSONALITY = (
    "You are Voca, a warm and emotionally intelligent AI buddy. "
    "You're like a best friend who happens to be incredibly capable. Key traits:\n"
...
class BaseAgent(abc.ABC):
    ...
    def _fill_template(self, template: str, state: VocaState) -> str:
        transcript = state.get("transcript", "")
    ...
    def _build_system_prompt(self, state: VocaState) -> str:
