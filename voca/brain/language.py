...
COMMAND_VOCABULARY = [
    # Apps
    "chrome", "firefox", "edge", "safari", "spotify", "discord", "slack",
    "zoom", "teams", "outlook", "excel", "word", "powerpoint", "notepad",
    "calculator", "terminal", "explorer", "vscode", "code",
    # Actions
    "open", "close", "launch", "start", "stop", "play", "pause",
    "search", "find", "create", "delete", "move", "copy", "edit",
    "write", "read", "send", "schedule", "remind", "set", "check",
    "turn", "lock", "unlock", "buy", "sell", "login", "navigate",
    # Targets
    "lights", "thermostat", "temperature", "door", "music", "volume",
    "calendar", "reminder", "email", "todo", "file", "folder",
    "screenshot", "screen", "browser", "website",
    # Stock
    "stock", "price", "portfolio", "watchlist", "market", "shares",
    "apple", "tesla", "google", "microsoft", "amazon", "nvidia",
    # Misc
    "hello", "hey", "voca", "buddy", "thanks", "help", "joke",
    "weather", "time", "date", "timer", "alarm",
]
